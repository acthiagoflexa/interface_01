...
namespace interface_01
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private void btnSalvar_Click(object sender, RoutedEventArgs e)
        {
            ...
            dadosPeca.codigoPeca = Convert.ToInt32(txtCodigoPeca.Text);
        ...
        private List<DadosPeca> CarregaDados()
        {
            ...
            foreach(JObject peca in arrayDaddos) // Converte Json para lista/Atribuir Váriaveis 
            {
                DadosPeca pecaList = new DadosPeca();
                pecaList.codigoPeca = Convert.ToInt32(peca["codigo"]);
